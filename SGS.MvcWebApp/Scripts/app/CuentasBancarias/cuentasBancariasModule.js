angular.module('contabilidad.cuentasBancarias', [
    'contabilidad.cuentasBancarias.ctrl.list',
    'contabilidad.cuentasBancarias.ctrl.edit',    
    ...
    function ($routeProvider, $locationProvider, $httpProvider) {
        $routeProvider.when('/', {
            templateUrl: 'cuentasBancarias/list',
            controller: 'listCtrl'
        });
              
        $routeProvider.when('/create/:empresaId', {
            templateUrl: 'cuentasBancarias/edit',
            controller: 'editCtrl'
        });
