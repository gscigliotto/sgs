angular.module('sgs.security.usuarios', [
    'sgs.security.usuarios.ctrl.list',
    'sgs.security.usuarios.ctrl.edit',
    'sgs.service.security',
    'sgs.service.usuarioValidation',
    ...
    function($routeProvider, $locationProvider, $httpProvider) {
        $routeProvider.when('/', {
            templateUrl: 'usuarios/list',
            controller: 'listCtrl'
        });

        $routeProvider.when('/create', {
            templateUrl: 'usuarios/edit',
            controller: 'editCtrl'
        });
