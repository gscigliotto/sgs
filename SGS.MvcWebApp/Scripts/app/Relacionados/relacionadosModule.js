angular.module('contabilidad.relacionados', [
    'contabilidad.relacionados.ctrl.list',
    'contabilidad.relacionados.ctrl.edit',
    'contabilidad.service.relacionados',
    ...
    function ($routeProvider, $locationProvider, $httpProvider) {
        $routeProvider.when('/', {
            templateUrl: 'relacionados/list',
            controller: 'listCtrl'
        });
              
        $routeProvider.when('/create', {
            templateUrl: 'relacionados/edit',
            controller: 'editCtrl'
        });
